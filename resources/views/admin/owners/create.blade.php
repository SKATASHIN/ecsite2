                    ...
                    <div class="lg:w-1/2 md:w-2/3 mx-auto" _msthidden="6">
                      <div class="-m-2" _msthidden="6">
                        ...
                        <div class="p-2 w-full flex justify-around mt-4" _msthidden="1">
                          <button onclick="location.href='{{ route('admin.owners.index') }}'" class=" bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg" _msthash="1322126" _msttexthash="79859" _msthidden="1">戻る</button>
                          <button class=" text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" _msthash="1322126" _msttexthash="79859" _msthidden="1">登録する</button>
                        </div>
                      </div>
                    </div>
                  </div>
