                      ...
                      <table class="table-auto w-full text-left whitespace-no-wrap" _msthidden="20">
                        <thead _msthidden="4">
                          <tr _msthidden="4">
                            ...
                            <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100" _msthash="1608141" _msttexthash="94432" _msthidden="1">期限が切れた日</th>
                        ...
                        <tbody _msthidden="16">
                          ...
                          <tr _msthidden="4">
                            ...
                            <td class="px-4 py-3" _msthash="1615304" _msttexthash="26858" _msthidden="1">{{ $owner->deleted_at->diffForHumans() }}</td>
                            <form id="delete_{{$owner->id}}" method="post" action="{{ route('admin.expired-owners.destroy', ['owner' => $owner->id ] )}}">
                              @csrf
                              <td class="px-4 py-3">
                                <a href="#" data-id="{{ $owner->id }}" onclick="deletePost(this)" class=" text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-500 rounded " _msthash="1322126" _msttexthash="79859" _msthidden="1">完全に削除</a>
                              </td>
                          </form>
                          </tr>
                          @endforeach
